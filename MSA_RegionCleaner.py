...
if len(sys.argv) < 2:
	...
	print "MSA_parser_cleaner.py AlignmentFile TypeOfEBV/[optional filter bed file]"
	sys.exit(1)
...
if sys.argv[2] == '1':
    ...
    Ref='NC_007605'
    Repeat_inputFile = sys.argv[2]


#Find the genomic locations fall into repeat regions
RepeatList = []
